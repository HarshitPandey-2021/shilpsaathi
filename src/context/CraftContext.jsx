...
const UI2 = {
  hi: { before:"पहले", after:"बाद में", aiWorking:"AI आपकी फोटो सुधार रहा है", enhanceFail:"AI सुधार नहीं हो सका", enhanceFailSub:"आपकी असली फोटो इस्तेमाल होगी", continueAnyway:"इसी फोटो से आगे बढ़ें", retry:"दोबारा कोशिश करें", dragCompare:"तुलना करने के लिए खिसकाएं",
        ...
        askInputs:"जांचें — गलत हो तो बदलें", publishToast:"आपकी दुकान में प्रकाशित!", phoneLinked:"दुकान आपके नंबर से जुड़ गई", phoneFail:"नहीं जुड़ सका, दोबारा करें", restoreShop:"मेरी दुकान वापस पाएं",sayMore:"थोड़ा और बताएं — क्या है, किस चीज़ का, क्या रंग, कितने घंटे लगे?",         settings:"सेटिंग्स", signOut:"साइन आउट", editProfile:"प्रोफ़ाइल बदलें", yourName:"आपका नाम", yourVillage:"गाँव / शहर", voiceOnAllSteps:"सभी चरणों पर चालू", artisanLabel:"कारीगर",needName:"पहले उत्पाद का नाम भरें", untitled:"हस्तनिर्मित शिल्प",catalogValue:"कुल कीमत", },

  en: { before:"Before", after:"After",        settings:"Settings", signOut:"Sign out", editProfile:"Edit profile", yourName:"Your name", yourVillage:"Village / city", voiceOnAllSteps:"On for all steps", artisanLabel:"Artisan", catalogValue:"Catalog value",aiWorking:"AI is improving your photo", enhanceFail:"AI enhancement unavailable", enhanceFailSub:"Your original photo will be used", continueAnyway:"Continue with this photo", retry:"Try again", dragCompare:"Drag to compare",  sayMore:"Tell me more — what is it, what material, what colour, how many hours?",       savePhoneTitle:"Save your shop", savePhoneSub:"Add your number so your listings are never lost", savePhoneBtn:"Save", skipForNow:"Skip for now",aiHeard:"AI heard this",        matCost:"Material cost", hoursWorked:"Hours worked", labourCost:"Labour", overhead:"Overhead (12%)", margin:"Your profit (25%)", totalCost:"Suggested price", perHour:"per hour",
